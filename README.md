...
######TODA ESTRUTURA FOI FEITA EM OHIO, POIS EM VIRGINIA ESTA O PROJETO TERRAFORM, ESTE BASEADO NO MESMO<h6>
...
* -  Restart do haproxy: systemctl restart haproxy
...
* - Acrecente ip e nome do haproxy 
vim /etc/hosts
